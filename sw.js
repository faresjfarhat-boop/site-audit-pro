/* Site Audit Pro service worker – offline app shell. Dropbox API calls are never cached. */
const CACHE='sap-2b034df1dc';const ASSETS=['./','./index.html','./manifest.webmanifest','./icon-192.png','./icon-512.png'];
